...
public class Menu {
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("6. Asignar pacientes a conductores (CAP)");
            System.out.println("7. Asignar conductores a carro fúnebre (CF)");
            System.out.println("8. Asignar muertos a carro fúnebre (muertosFunebre)");
            ...
            switch (opcion) {
                ...
                case 6:
                    Metodos.CAP();
                    System.out.println("Pacientes asignados a conductores.");
                    break;
                case 7:
                    Metodos.CF();
